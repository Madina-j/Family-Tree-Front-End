...
export default function ConnectionForm() {
  ...
  async function submit(e) {
    ...
    if (validate()) {
      navigate(
        `/connection/result?${objectToHttpParams({
          person1: person1.id,
          person2: person2.id,
        })}`
      )
    ...
    <>
      ...
      <form onSubmit={submit} onChange={() => setErrors({})}>
        <div className="row mb-3">
          <label htmlFor="inputPerson1" className="col-sm-2 col-form-label">
            Family Member 1:
          </label>
          <div className="col-sm-10">
            <div className="input-group w-100">
              <PersonPicker
                ...
                value={person1}
                onChange={setPerson1}
                exclude={[person2].filter(Boolean)}
        ...
        <div className="row mb-3">
          <label htmlFor="inputPerson2" className="col-sm-2 col-form-label">
            Family Member 2:
          </label>
          <div className="col-sm-10">
            <div className="input-group w-100">
              <PersonPicker
                ...
                value={person2}
                onChange={setPerson2}
                exclude={[person1].filter(Boolean)}
